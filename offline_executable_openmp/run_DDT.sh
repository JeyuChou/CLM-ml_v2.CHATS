...
# --- LOAD LINARO FORGE ---
module load linaro-forge/25.1.3
...
make 
echo "Running the executable with Linaro DDT..."

# Give threads plenty of space to prevent debug crashes
export OMP_STACKSIZE=128M
export OMP_NUM_THREADS=1
export ULIMIT_S=unlimited

# Start DDT via reverse connect instead of running directly
ddt --connect ./prgm.exe < nl.all_CHATS7.05.2007